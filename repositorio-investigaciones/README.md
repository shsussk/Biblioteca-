...
2. Reemplaza en las políticas RLS (schema.sql) el correo dmin@tudominio.com por el tuyo.
...
- Accede a dmin/login.html e inicia sesión con las credenciales del admin.
